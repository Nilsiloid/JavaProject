...
public class Madhav extends Seller { // IMT2021009 seller
    ...
    public void addProduct() { // Method to set the products that each seller sells
        Book b3 = new Book(Category.Book, "b3", "Madhav-b3", 30, 5); // Book product
        Book b4 = new Book(Category.Book, "b4", "Madhav-b4", 20, 4); // Book product
        Mobile m3 = new Mobile(Category.Mobile, "m3", "Madhav-m3", 25, 9); // Mobile product
        Mobile m4 = new Mobile(Category.Mobile, "m4", "Madhav-m4", 35, 6); // Mobile Product
