...
public class Nilay extends Seller { // IMT2021096 seller
    ...
    public void addProduct() { // Method to set the products that each seller sells
        Book b1 = new Book(Category.Book, "b1", "Nilay-b1", 200, 10); // Book product
        Book b2 = new Book(Category.Book, "b2", "Nilay-b2", 450, 22); // Book product
        Mobile m1 = new Mobile(Category.Mobile, "m1", "Nilay-m1", 22500, 9); // Mobile product
        Mobile m2 = new Mobile(Category.Mobile, "m2", "Nilay-m2", 12000, 13); // Mobile product
