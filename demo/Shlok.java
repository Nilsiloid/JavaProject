...
public class Shlok extends Seller { // IMT2021103 seller
    ...
    public void addProduct() { // Method to set the products that each seller sells
        Book b5 = new Book(Category.Book, "b5", "Shlok-b5", 30, 5); // Book product
        Book b6 = new Book(Category.Book, "b6", "Shlok-b6", 20, 4); // Book product
        Mobile m5 = new Mobile(Category.Mobile, "m5", "Shlok-m5", 25, 9); // Mobile product
        Mobile m6 = new Mobile(Category.Mobile, "m6", "Shlok-m6", 35, 6); // Mobile product
